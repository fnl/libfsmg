...
public class TestExactMatcher {
  ...
  public final void testSearch() {
    ...
    List<Character> sub = new LinkedList<Character>();
    sub.add(Character.valueOf('c'));
    sub.add(Character.valueOf('d'));
    sub.add(Character.valueOf('e'));
    s.add('a');
    s.add('b');
    s.add('c');
    s.add('d');
    ...
    s.add('g');
    s.add('h');
    assertEquals(sub, pattern.search(s.iterator()));
